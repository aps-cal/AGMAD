...
*/    
    $.fn.getdata = function($uri) {
        $.ajax({
            type: 'GET',
            url: $uri, //'//aglum.lnx.warwick.ac.uk/it/computers'
            //data: {field: 'value'},
            dataType: 'jsonp',
            crossDomain: true,
            timeout: 0,
...
*/        
	...
	function getEquip(){
            ...
            var formdata = $("#computers").serialize();
            formdata = '&ALTag='+alTag+'&'+formdata;  // Changed 17 Apr 2019 - possible duplication of ALTag
            //alert(formdata);
            $.ajax({
                    type: 'GET',
            ...
            // If alTag was zero then clear fields - New Record
            if(alTag){ } else {/*alTag = 0;}
            if(alTag == 0){*/
                $("input#NewEdit").click();
            }
	...
	function newEquip(){
            var formdata = $("#computers").serialize();
            formdata = '&ALTag=0&'+formdata;  // Changed 18 Apr 2019 - possible duplication of ALTag
            alert(formdata);
            $.ajax({
                    type: 'GET',
                    url: '//aglum.lnx.warwick.ac.uk/it/getequipment',
	...
	$("input#Dumped").click(function(e){
        ...
        $("input#NewEdit").click(function(e){
                $("input[name='ALTag']").val('');
                //$("input[name='AL_Tag']").val(''); // Added 17 Apr 2019
		$(".Combo").prop('disabled', false);
		$(".Alist").prop('disabled', false);
		$(".Toggle").prop('disabled', false);
		$(".Notes").prop('disabled', false);
