...
/*
        ...
        'EL_APIUSER_PR' => [
            'driver' => 'oracle',
            'host' => env('PRAPI_HOST', 'sitspr.warwick.ac.uk'),
            'port' => env('PRAPI_PORT', '1521'),
            'database' => env('PRAPI_DATABASE', 'sitspr.warwick.ac.uk'),
            'service_name' => env('PRAPI_SID', 'sitspr.warwick.ac.uk'),
            'username' => env('PRAPI_USERNAME', 'EL_APIUSER'),
            'password' => env('PRAPI_PASSWORD', 'BrownDogHair_23'),
            'charset' => 'utf8',
            'prefix' => '',
        ],
        'CAL_APP_PR' => [
